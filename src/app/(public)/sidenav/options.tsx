...
export function RailRefined() {
  return (
    <div className="sn sn--rail">
      <div className="sn__ribbon"><div className="sn__fill" /></div>
      <button type="button" className="sn__square sn__square--foot" aria-label="Back to the foundations"><Chevron /></button>
    </div>
  )
}
...
export function ThreadBead() {
  return (
    <div className="sn sn--thread">
      ...
      <button type="button" className="sn__bead-home" aria-label="Back to the foundations"><Chevron /></button>
    </div>
  )
}
...
export function FloatingPill() {
  return (
    <div className="sn sn--pill">
      ...
      <div className="sn__pill-track"><div className="sn__pill-fill" /></div>
      <button type="button" className="sn__pill-home" aria-label="Back to the foundations"><Chevron /></button>
    </div>
  )
}
...
export function DotsColumn() {
  return (
    <div className="sn sn--dots">
      ...
      <ol>
        {[0, 1, 2, 3, 4, 5].map((i) => (
          <li key={i} className="sn__dot" data-current={i === 3 ? 'true' : undefined} data-read={i < 3 ? 'true' : undefined}>
            {i === 3 && (
              <svg viewBox="0 0 32 32" className="sn__dot-ring" aria-hidden>
                <circle cx="16" cy="16" r="14" fill="none" stroke="var(--tc-track)" strokeWidth="2" />
                <circle className="sn__dot-progress" cx="16" cy="16" r="14" fill="none" stroke="var(--tc-deep)" strokeWidth="2" strokeLinecap="round" strokeDasharray="87.96" strokeDashoffset="39.6" transform="rotate(-90 16 16)" />
              </svg>
            )}
          </li>
        ))}
...
export function MarginContents() {
  return (
    <nav className="sn sn--contents" aria-label="Chapter contents">
      ...
      <div className="sn__contents-line"><div className="sn__contents-fill" /></div>
      <ol>
        {['Head', 'Heart', 'Hands'].map((l, i) => (
          <li key={l} data-state={i === 0 ? 'done' : i === 1 ? 'current' : undefined}><span /> {l}</li>
        ))}
      </ol>
    </nav>
  )
    ...
    <div className="sn sn--ring">
      <button type="button" className="sn__ring-btn" aria-label="Back to the foundations">
        <svg viewBox="0 0 64 64" width="64" height="64" aria-hidden>
          ...
          <circle className="sn__ring-progress" cx="32" cy="32" r="29" fill="none" stroke="var(--tc)" strokeWidth="2.5" strokeLinecap="round" strokeDasharray="182.2" strokeDashoffset="82" transform="rotate(-90 32 32)" />
        </svg>
        <span className="sn__ring-mark"><Mark size={34} /></span>
      </button>
    </div>
  )
}
...
export function EditorialStrip() {
  return (
    <div className="sn sn--strip">
      ...
      <div className="sn__strip-track"><div className="sn__strip-fill" /></div>
      <button type="button" className="sn__strip-home" aria-label="Back to the foundations"><Chevron /></button>
    </div>
  )
}
...
export function Bookmark() {
  return (
    <div className="sn sn--bookmark">
      ...
      <button type="button" className="sn__bookmark-home" aria-label="Back to the foundations"><Chevron /></button>
    </div>
  )
}
...
export function InsetRail() {
  return (
    <div className="sn sn--inset">
      <div className="sn__inset-track"><div className="sn__inset-fill" /></div>
      <button type="button" className="sn__inset-home" aria-label="Back to the foundations"><Chevron /></button>
    </div>
  )
}
