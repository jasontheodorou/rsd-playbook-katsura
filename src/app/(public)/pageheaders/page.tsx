...
import { Contents, Exploded, Journey, MarkLarge, Numeral, PhotoCircle, ProgressRings } from './visuals'
...
/** Seven candidates for the space beside a chapter heading, each shown in place. */
    ...
    <div className="ph">
      <header className="ph__intro">
        ...
        <p className="ph__blurb">
          Seven ways to fill the space beside a chapter heading once the illustration goes. Each is shown in
          place with the real heading and opening text. Motion is slow and switches off under reduced motion.
        </p>
      </header>
